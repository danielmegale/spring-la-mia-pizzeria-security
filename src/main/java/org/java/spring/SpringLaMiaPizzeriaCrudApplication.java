...
public class SpringLaMiaPizzeriaCrudApplication implements CommandLineRunner {
	...
	public void run(String...args) throws Exception{
		...
		pizzaService.save(new Pizza("Patatosa", "Pizza con modoro, mozzarella e patatine fritte", 6.99, null,ing1,ing2,ing4));
		pizzaService.save(new Pizza("4 Formaggi", "Pizza con mozzarella, Certosino, Gorgonzola D.O.P. Gim e parmigiano grattugiato,", 6.99, null,ing2,ing4));
		pizzaService.save(new Pizza("Prosciutto cotto", "Pizza con modoro, mozzarella e prosciutto cotto", 6.99, null,ing3,ing1));
